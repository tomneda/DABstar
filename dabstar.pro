...
RC_ICONS	=  res/logo/qt-dab-6.ico
RESOURCES	+= resources.qrc

DEFINES		+= APP_NAME=\\\"$$TARGET\\\"
DEFINES		+= PRJ_NAME=\\\"DABstar\\\"
DEFINES		+= PRJ_VERS=\\\"2.8.1\\\"
...
#CONFIG		+= tcp-streamer
# otherwise, if you want to use the default qt way of sound
...
tcp-streamer	{
	...
	QT		+= network
	HEADERS		+= scr/output/tcp-streamer.h
...
portaudio	{
	LIBS		+= -lportaudio
        HEADERS         += src/output/audiosink.h
        SOURCES         += src/output/audiosink.cpp
}
