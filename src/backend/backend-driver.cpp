...
BackendDriver::BackendDriver(RadioInterface * mr, const DescriptorType * d, RingBuffer<int16_t> * audioBuffer, RingBuffer<uint8_t> * dataBuffer, RingBuffer<uint8_t> * frameBuffer, FILE * dump)
{
