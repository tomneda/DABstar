...
bool RtlSdrHandler::load_rtlFunctions(bool & oHasNewInterface)
{
  oHasNewInterface = true; // is it a old-dab-style interface?
  ...
  rtlsdr_get_usb_strings = (pfnrtlsdr_get_usb_strings)phandle->resolve("rtlsdr_get_usb_strings");
  ...
  rtlsdr_set_sample_rate = (pfnrtlsdr_set_sample_rate)phandle->resolve("rtlsdr_set_sample_rate");
  ...
  rtlsdr_set_tuner_gain_mode = (pfnrtlsdr_set_tuner_gain_mode)phandle->resolve("rtlsdr_set_tuner_gain_mode");
  ...
  rtlsdr_set_agc_mode = (pfnrtlsdr_set_agc_mode)phandle->resolve("rtlsdr_set_agc_mode");
  ...
  rtlsdr_set_center_freq = (pfnrtlsdr_set_center_freq)phandle->resolve("rtlsdr_set_center_freq");
  ...
  rtlsdr_get_center_freq = (pfnrtlsdr_get_center_freq)phandle->resolve("rtlsdr_get_center_freq");
  ...
  rtlsdr_reset_buffer = (pfnrtlsdr_reset_buffer)phandle->resolve("rtlsdr_reset_buffer");
  ...
  rtlsdr_read_async = (pfnrtlsdr_read_async)phandle->resolve("rtlsdr_read_async");
  ...
  rtlsdr_get_device_count = (pfnrtlsdr_get_device_count)phandle->resolve("rtlsdr_get_device_count");
  ...
  rtlsdr_cancel_async = (pfnrtlsdr_cancel_async)phandle->resolve("rtlsdr_cancel_async");
  ...
  rtlsdr_set_freq_correction_ppb = (pfnrtlsdr_set_freq_correction_ppb)phandle->resolve("rtlsdr_set_freq_correction_ppb");
  if (rtlsdr_set_freq_correction_ppb == nullptr)
  {
  ...
  rtlsdr_get_device_name = (pfnrtlsdr_get_device_name)phandle->resolve("rtlsdr_get_device_name");
  ...
  rtlsdr_set_tuner_bandwidth = (pfnrtlsdr_set_center_freq)phandle->resolve("rtlsdr_set_tuner_bandwidth");
  if (rtlsdr_set_tuner_bandwidth == nullptr)
  {
  ...
  rtlsdr_set_bias_tee = (pfnrtlsdr_set_bias_tee)phandle->resolve("rtlsdr_set_bias_tee");
  if (rtlsdr_set_bias_tee == nullptr)
  {
    // nullpointer - if function is not available - is handled
  ...
  rtlsdr_get_tuner_i2c_register = (pfnrtlsdr_get_tuner_i2c_register)phandle->resolve("rtlsdr_get_tuner_i2c_register");
  ...
  rtlsdr_get_tuner_type = (pfnrtlsdr_get_tuner_type)phandle->resolve("rtlsdr_get_tuner_type");
