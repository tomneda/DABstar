...
Open the **Spectrum Scope** with the ![](../../res/for_readme/scope-button.png){height=1.1em}
button in the main window.

## Spectrum, correlation and statistics

![Scope, spectrum, correlation and statistics window](../../res/for_readme/scope-spec-corr.png){width=100%}
...
![PRS correlation over a whole DAB frame](../../res/for_readme/corr-over-frame.png){width=100%}
