...
![Technical details window of the selected service](../../res/for_readme/tech-details.png)
...
![FIB content window](../../res/for_readme/fib-content.png)
...
![Journaline window](../../res/for_readme/journaline.png)
...
![](../../res/for_readme/device-button.png) button.

![RTL-SDR device window](../../res/for_readme/device-rtlsdr.png)

![HackRF device window](../../res/for_readme/device-hackrf.png)

![SDRplay device window](../../res/for_readme/device-sdrplay.png)
...
![The DABstar version update dialog](../../res/for_readme/update.png)
